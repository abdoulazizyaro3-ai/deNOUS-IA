...
import { User, Globe, Mail, MapPin, BookOpen, Compass, LogOut } from "lucide-react";
...
export default function MonCompte({ currentUser, onLogout }: MonCompteProps) {
  // Use real user data or fallback to defaults if somehow missing
  const userProfile = {
  ...
  return (
    <div className="px-6 md:px-12 py-8 max-w-4xl mx-auto w-full space-y-6">
      {/* Header */}
      <div className="border-b border-[#EADBC8] pb-4 flex justify-between items-start">
        <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-white p-6 rounded-3xl border border-[#EADBC8] shadow-sm text-center space-y-4 md:col-span-1">
          <div className="relative w-24 h-24 mx-auto bg-[#F5ECE1] rounded-full border-4 border-[#FAF6F0] shadow-sm flex items-center justify-center">
            <User size={40} className="text-[#C1561F]" />
        ...
        <div className="space-y-6 md:col-span-2">
          ...
          <div className="bg-white p-6 rounded-3xl border border-[#EADBC8] shadow-sm space-y-3">
            ...
            <p className="text-xs text-[#2B1810]/70 leading-relaxed">
              Vous pouvez interroger l'assistant vocal ou utiliser le chat pour obtenir des réponses précises tirées directement de nos bases de données sur l'Afrique.
            </p>
          </div>
          ...
          <div className="bg-[#FAF6F0]/50 p-6 rounded-3xl border border-[#EADBC8] space-y-4">
            ...
            <ul className="space-y-3 text-xs text-[#2B1810]/80">
              <li className="flex items-start gap-2.5">
                ...
                <p className="mt-0.5">Pour obtenir des informations détaillées, utilisez l'onglet <strong>Explorer l'Afrique</strong> ou posez directement vos questions à notre <strong>Assistant vocal</strong>.</p>
              </li>
              <li className="flex items-start gap-2.5">
                <span className="w-5 h-5 rounded-full bg-[#F5ECE1] flex items-center justify-center shrink-0 font-bold text-[#C1561F]">2</span>
                <p className="mt-0.5">L'onglet <strong>Messages</strong> vous permet de mener des conversations plus longues, de faire des recherches ciblées et d'exporter des comptes rendus écrits sur les thématiques africaines.</p>
              </li>
              <li className="flex items-start gap-2.5">
